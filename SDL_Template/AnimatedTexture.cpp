...
namespace SDLFramework {
	...
	AnimatedTexture::AnimatedTexture(std::string filename, int x, int y, int w, int h, int frameCount, float animationSpeed, Animation::Layouts layout, bool managed) : Texture(filename, x, y, w, h, managed) {
		mTimer = new Timer();
